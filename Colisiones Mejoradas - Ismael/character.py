...
class Character(pygame.sprite.Sprite):
    ...
    def colision_horizontal(self, tough_platforms, dt):
    ...
    def colision_vertical(self, tough_platforms,  dt):
    ...
    def colision_normal_platform(self, tough_platforms, dt):
        self.colision_horizontal(tough_platforms, dt)        
        self.colision_vertical(tough_platforms, dt)


    def colision_platforms (self, platforms, dt):
        self.v_speed += self.gravity * dt
        self.rect.centery += self.v_speed * dt
    ...
    def colision_double_jump_in_wall (self, wall, dt):
        self.rect.centerx += self.h_speed * dt
        ...
        for hit in hits:
                if self.h_speed > 0:
                    ...
                    self.h_speed = 0
                    self.movement[3] = True
        self.colision_vertical(wall, dt)
    ...
    def update_pos(self, dt, platforms):
        ...
        self.colision_normal_platform(platforms, dt)
