...
class Map:
    def __init__(self, bg = "./Sprites/Back.png", chars = None, floor = None, decorations = None, platforms = None, obst = None,  slime = None):
        ...
        self.platforms = platforms or [Platform(20, 25, "./Sprites/Platform.png", 10, 1), Platform(32, 22, "./Sprites/Platform.png", 10, 1)]
        self.obst = obst or [Obstacle_h(0, 24, 10), Obstacle_v(39, 29, 10), Spike(40, 29)]
        self.slime = slime or [Obstacle_h(0,29,1,"./Sprites/Slime.png",0)]
