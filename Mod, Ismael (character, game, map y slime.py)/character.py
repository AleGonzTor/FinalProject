...
class Character(pygame.sprite.Sprite):
    def __init__(self, x = (TILES_X - 1) * TILE_SIZE, y =(TILES_Y - 1) * TILE_SIZE, picture_path = "Sprites\Char.png"):
        ...
        #Esta caracteristica es para reconocer si el personaje está tocando un muro
    ...
    def jump(self):
        if self.movement[3]:  # Puede saltar (suelo o pared)
            self.v_speed = self.j_speed   # salto normal
