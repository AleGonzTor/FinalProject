...
class Game:
    ...
    def main_void(self):
        while True:
            ...
            for spike in self.curr_map.get_spikes():
                spike.update(self.curr_map.get_collision_group(), self.curr_map.get_char(), dt)
            for slime in self.slimes:
                slime.update()
            for enemy in self.curr_map.get_enemies():
                enemy.update(dt, collision_group)
            ...
            self.curr_map.spikes_group.draw(self.display)
